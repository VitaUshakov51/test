...
function f2() {
    const input = document.querySelector('.b-2').value;
    alert(input);
}
...
function f4() {
    ...
    if (input.checked) {
        out.innerHTML = 'Инпут выбран';
    } else {
        out.innerHTML = 'Инпут не выбран';
    }
...
function f5() {
    ...
    if (input.checked) {
        ...
        out.innerHTML = 'Поставьте галочку';
    }
}
...
function f7() {
    ...
    const outOne = document.querySelector('.out-71');
    const outTwo = document.querySelector('.out-72');
    outOne.innerHTML = password;
    if (password.length >= 6) {
        outTwo.innerHTML = 'Пароль имеет 6 или более символов';
    } else {
        outTwo.innerHTML = 'Пароль слишком короткий';
    }
}
...
function f8() {
    ...
    outOne.innerHTML = `<input class="i-81" type="text"><button class="b-81" type="button">Go</button>`
    document.querySelector('.b-81').onclick = f81;
}

function f81() {
    const out = document.querySelector('.out-81');
    const input = document.querySelector('.i-81').value;
    out.innerHTML = input;
}
...
out.innerHTML = `Ваш логин:${input.value}  Ваш пароль:${password.value}`;
}
...
out.innerHTML = `Ваш логин:${form.elements['username'].value} Ваш пароль:${form.elements['password'].value}`;
}
