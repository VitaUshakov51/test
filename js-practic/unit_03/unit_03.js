...
function f9() {
    ...
    if (num >= 1 && num <= 32) {
        out.innerHTML = '1 Подъезд';
    } else if (num >= 33 && num <= 43) {
        out.innerHTML = '2 Подъезд';
    } else if (num >= 44 && num <= 64) {
        out.innerHTML = '3 Подъезд';
    } else {
        out.innerHTML = 'Такой квартиры нет';
    }
}
...
function f15() {
    ...
    const c = document.querySelector('.s-153').value;
