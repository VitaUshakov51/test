...
let divThree = document.querySelector('.one');
divThree.innerHTML = 'Hello world';
...
let everyone = document.querySelector('h2 span');
everyone.innerHTML = 'WORLD';



// Task 10.
//Создайте пустой div c классом three. С помощью querySelector запишите внутрь div заголовок h3 с произвольным текстом.
let divTen = document.querySelector('.three');
divTen.innerHTML = `<h3>Тут какой-то заголовок</h3>`
...
four.innerHTML += `<h4>Привет!</h4><p>Ну че выучишь js на этот раз?</p>`
