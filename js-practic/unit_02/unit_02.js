...
let f1 = 5;
let res4 = e1 + f1;
document.querySelector('.out-4').textContent = `Выведем строку ${res4}`;
...
function t8() {
    let input = document.querySelector('.i-0').value;
    console.log(input);
}
...
function t9() {
    let inputIn = document.querySelector('.i-9').value;
...
function t10() {
    let inputTypeNum = document.querySelector('.i-10').value;
    let out = document.querySelector('.out-10');
    out.innerHTML = inputTypeNum * 10;
    inputTypeNum = '';
}
...
let lastName = document.querySelector('.i-12_2').value;
let out = document.querySelector('.out-12');
out.innerHTML = `Привет ${name} ${lastName}`
}
...
function t13() {
let a = document.querySelector('.i-13_1').value;
let b = document.querySelector('.i-13_2').value;
...
out.innerHTML = `Уважаемый ${name} ${lastName} Ваш возраст - ${age} года, Профессия - ${work}`
}
